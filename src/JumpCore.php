...
class JumpCore
{
     ...
     */
    public function success(?string $msg = null, ?string $url = null, ?int $wait = null, array $header = [], $data = null): Response
    {
        // URL处理
        if (null === $url) {
     ...
     * @throws HttpResponseException
     */
    public function error(?string $msg = null, ?string $url = null, ?int $wait = null, array $header = [], $data = null): Response
    {
        // URL处理
        if (null === $url) {
     ...
     * @throws HttpResponseException
     */
    public function redirect(?string $url = null, ?string $msg = null, int $code = 302, array $header = []): Response
    {
        // URL处理
        $url = self::buildUrl($url);
     ...
     * @throws HttpResponseException
     */
    public function result(mixed $data = null, ?int $code = null, ?string $msg = null, ?string $type = null, array $header = []): Response
    {
        $result = [
     ...
     * @return $this
     */
    public function returnResponse(bool $return = true): JumpCore
    {
